      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <div className="hero-stats">
            ...
            <p>Resume scanning and keyword guidance to beat the ATS filters</p>
        ...
        <div className="portal-grid">
          ...
          <div className="portal-card">
            ...
            <p>View hiring companies, required skills, candidate pipeline, AI screening, and offer management.</p>
                        <p>View hiring companies, required skills, candidate pipeline, screening, and offer management.</p>
